		...
		<footer className="relative bg-gray-100 dark:bg-gray-900">
			<div className="relative mx-auto px-2 lg:px-16 w-full">
				...
				<div className="px-4 py-6 md:flex md:items-center md:justify-between">
					<div
						className="flex mt-4 justify-center text-center text-sm text-gray-700 lg:justify-start dark:text-gray-300"
					>
						{ config.footer.copyright ?? (<span>
							© 2013-{ new Date().getFullYear().toString().slice(-2) }&nbsp;<strong><a
							href="https://www.stechbd.net" target="_blank">S Technologies</a></strong>. Built with&nbsp;
							<strong><a href="https://www.stechbd.net/product/WP-Next"
							           target="_blank">WP-Next</a></strong>.
						</span>) }
					</div>
					{ config.footer.social &&
						<div className="flex mt-4 space-x-5 justify-center lg:mt-0 lg:justify-end">
							...
							{ config.footer.social.x &&
								<Link href={ config.footer.social.x } target="_blank" className="text-gray-700">
